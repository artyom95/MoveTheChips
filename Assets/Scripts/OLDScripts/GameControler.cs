...
public class GameControler : MonoBehaviour
{
    ...
    [FormerlySerializedAs("_chipMover")] [SerializeField]
    private ChipMoover _chipMoover;
    ...
    {
        FillFields();
        _dataDfsLoader.Initialize(_coordinatesPoints, _initialPointLocation, _connectionsBetweenPointsPairs,
            _amountPoints);
        _listPlaces = _screenDisplayLoader.Initialize(_coordinatesPoints, _colorList, _initialPointLocation,
